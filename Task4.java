...
/*
Provide Implementation for the diagram below. Then create a test class in which you need to create Objects of ChromeDriver,
FirefoxDrive and SafariDriver classes and see which methods available to them.
 */
public class Task4 {

    public static void main(String[] args) {
        remoteWebDriver [] webDriver={ new ChromeDrive(),new FirefoxDrive(), new SafariDriver()};
...
class ChromeDrive implements remoteWebDriver, takeScreenShot{
    @Override
    public void open() {
